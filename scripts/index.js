const initialCards = [
  { name: "Golden Gate Bridge", link: "https://image2url.com/images/1762072669619-00deadbb-9fa3-45b0-81e7-5e59d7e075dd.jpg" },
...
function handleEscClose(evt) {
  if (evt.key === "Escape") {
    const openModalEl = document.querySelector(".modal.modal_is-opened");
